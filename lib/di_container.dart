...
import 'package:karingo_seller/features/auth/domain/repositories/auth_repository.dart';
import 'package:karingo_seller/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:karingo_seller/features/auth/domain/services/auth_service.dart';
import 'package:karingo_seller/features/auth/domain/services/auth_service_interface.dart';
import 'package:karingo_seller/features/bank_info/domain/repositories/bank_info_repository_interface.dart';
import 'package:karingo_seller/features/bank_info/domain/services/bank_info_service.dart';
...
import 'package:karingo_seller/features/barcode/domain/repositories/barcode_repository.dart';
import 'package:karingo_seller/features/barcode/domain/repositories/barcode_reposity_interface.dart';
import 'package:karingo_seller/features/barcode/domain/services/barcode_service.dart';
import 'package:karingo_seller/features/barcode/domain/services/barcode_service_interface.dart';
import 'package:karingo_seller/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:karingo_seller/features/chat/domain/services/chat_service.dart';
import 'package:karingo_seller/features/chat/domain/services/chat_service_interface.dart';
import 'package:karingo_seller/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:karingo_seller/features/coupon/domain/services/coupon_service.dart';
import 'package:karingo_seller/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:karingo_seller/features/delivery_man/domain/repositories/delivery_man_repository_interface.dart';
import 'package:karingo_seller/features/emergency_contract/domain/repositories/emergency_contract_repository_interface.dart';
import 'package:karingo_seller/features/delivery_man/domain/services/delivery_service.dart';
import 'package:karingo_seller/features/delivery_man/domain/services/delivery_service_interface.dart';
import 'package:karingo_seller/features/emergency_contract/domain/services/emergency_contruct_service_interface.dart';
import 'package:karingo_seller/features/emergency_contract/domain/services/emergency_service.dart';
import 'package:karingo_seller/features/notification/controllers/notification_controller.dart';
import 'package:karingo_seller/features/notification/domain/repositories/notification_repository.dart';
import 'package:karingo_seller/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:karingo_seller/features/notification/domain/services/notification_service.dart';
...
import 'package:karingo_seller/features/order/domain/repositories/order_repository_interface.dart';
import 'package:karingo_seller/features/order/domain/services/location_service.dart';
import 'package:karingo_seller/features/order/domain/services/location_service_interface.dart';
import 'package:karingo_seller/features/order/domain/services/order_service.dart';
import 'package:karingo_seller/features/order/domain/services/order_service_interface.dart';
import 'package:karingo_seller/features/order_details/controllers/order_details_controller.dart';
import 'package:karingo_seller/features/order_details/domain/repositories/order_details_repository.dart';
import 'package:karingo_seller/features/order_details/domain/repositories/order_details_repository_interface.dart';
import 'package:karingo_seller/features/order_details/domain/services/order_details_service.dart';
import 'package:karingo_seller/features/order_details/domain/services/order_details_service_interface.dart';
import 'package:karingo_seller/features/pos/domain/repository/cart_repository_interface.dart';
import 'package:karingo_seller/features/pos/domain/services/cart_service.dart';
import 'package:karingo_seller/features/pos/domain/services/cart_service_interface.dart';
import 'package:karingo_seller/features/product/domain/repositories/product_repository_interface.dart';
import 'package:karingo_seller/features/product/domain/services/product_service.dart';
import 'package:karingo_seller/features/product_details/controllers/productDetailsController.dart';
import 'package:karingo_seller/features/product_details/domain/repositories/product_details_repository.dart';
import 'package:karingo_seller/features/product_details/domain/repositories/product_details_repository_interface.dart';
import 'package:karingo_seller/features/product_details/domain/services/product_details_service.dart';
import 'package:karingo_seller/features/product_details/domain/services/product_details_service_interface.dart';
...
import 'package:karingo_seller/features/profile/domain/services/profile_service.dart';
import 'package:karingo_seller/features/refund/domain/repositories/refund_repository_interface.dart';
import 'package:karingo_seller/features/refund/domain/services/refund_service.dart';
import 'package:karingo_seller/features/refund/domain/services/refund_service_interface.dart';
import 'package:karingo_seller/features/review/domain/repositories/product_review_repository_interface.dart';
import 'package:karingo_seller/features/review/domain/services/review_service.dart';
import 'package:karingo_seller/features/review/domain/services/review_service_interface.dart';
import 'package:karingo_seller/features/settings/domain/repositories/buisness_repository_interface.dart';
import 'package:karingo_seller/features/settings/domain/repositories/business_repository.dart';
import 'package:karingo_seller/features/pos/domain/repository/cart_repository.dart';
import 'package:karingo_seller/features/chat/domain/repositories/chat_repository.dart';
import 'package:karingo_seller/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:karingo_seller/features/delivery_man/domain/repositories/delivery_man_repository.dart';
import 'package:karingo_seller/features/emergency_contract/domain/repositories/emergency_contact_repository.dart';
import 'package:karingo_seller/features/order/domain/repositories/location_repository.dart';
import 'package:karingo_seller/features/order/domain/repositories/order_repository.dart';
import 'package:karingo_seller/features/profile/domain/repositories/profile_repository.dart';
import 'package:karingo_seller/features/refund/domain/repositories/refund_repository.dart';
import 'package:karingo_seller/features/settings/domain/services/business_service.dart';
import 'package:karingo_seller/features/settings/domain/services/business_service_interface.dart';
import 'package:karingo_seller/features/shipping/domain/repositories/shipping_repository_interface.dart';
import 'package:karingo_seller/features/shipping/domain/services/shipping_service.dart';
import 'package:karingo_seller/features/shipping/domain/services/shipping_service_interface.dart';
import 'package:karingo_seller/features/addProduct/domain/repository/add_product_repository.dart';
import 'package:karingo_seller/features/shipping/domain/repositories/shipping_repository.dart';
import 'package:karingo_seller/features/shop/domain/repositories/shop_repository.dart';
import 'package:karingo_seller/features/addProduct/domain/repository/add_product_repository_interface.dart';
import 'package:karingo_seller/features/addProduct/domain/services/add_product_service.dart';
import 'package:karingo_seller/features/addProduct/domain/services/add_product_service_interface.dart';
import 'package:karingo_seller/features/shop/domain/repositories/shop_repository_interface.dart';
import 'package:karingo_seller/features/shop/domain/services/shop_service.dart';
import 'package:karingo_seller/features/shop/domain/services/shop_service_interface.dart';
import 'package:karingo_seller/features/splash/domain/repositories/splash_repository.dart';
import 'package:karingo_seller/features/bank_info/domain/repositories/bank_info_repository.dart';
import 'package:karingo_seller/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:karingo_seller/features/splash/domain/services/splash_service.dart';
import 'package:karingo_seller/features/splash/domain/services/splash_service_interface.dart';
import 'package:karingo_seller/features/transaction/domain/repositories/transaction_repository.dart';
...
import 'package:karingo_seller/features/transaction/domain/repositories/transaction_repository_interface.dart';
import 'package:karingo_seller/features/transaction/domain/services/transaction_service.dart';
import 'package:karingo_seller/features/transaction/domain/services/transaction_service_interface.dart';
import 'package:karingo_seller/features/wallet/controllers/wallet_controller.dart';
import 'package:karingo_seller/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:karingo_seller/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:karingo_seller/features/wallet/domain/services/wallet_service.dart';
