...
class OrderShimmerWidget extends StatelessWidget {
  ...
  const OrderShimmerWidget({Key? key, required this.isEnabled})
      : super(key: key);
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text(
                ...
                style: titilliumBold.copyWith(
                    color: ColorResources.colorLightBlack, fontSize: 14),
              ),
              Text('\$0.00',
                  style: titilliumBold.copyWith(
                      color: ColorResources.gainsBro, fontSize: 14)),
            ]),
            Row(
              children: [
                Text('00:00',
                    style: titilliumRegular.copyWith(
                        color: ColorResources.gainsBro, fontSize: 10)),
                const SizedBox(width: 5),
                const Text(
                  '|',
                  style: TextStyle(color: ColorResources.gainsBro),
                ),
                const SizedBox(width: 5),
                Text('1 items : item',
                    style: titilliumRegular.copyWith(
            ...
            Row(
              ...
              children: [
                TextButton(
                    ...
                    child: Text('Name',
                        style: titilliumBold.copyWith(
                            color: ColorResources.gainsBro, fontSize: 15))),
                const Expanded(child: SizedBox()),
                Text(
                  '${getTranslated('view_details', context)}',
                  style: titilliumRegular.copyWith(
                      color: ColorResources.gainsBro, fontSize: 12),
                ),
                const Icon(
                  Icons.arrow_forward_outlined,
                  color: ColorResources.gainsBro,
                )
              ],
            )
          ],
