                            ...
                            return Consumer<ProductReviewController>(
                              ...
                              return Padding(
                                ...
                                child: FlutterSwitch(
                                    ...
                                    padding: 2,
                                    value: productSwitch
                                        ? details.productDetails?.status == 1
                                        : reviewSwitch
                                            ? productReview.reviewList[index!]
                                                    .status ==
                                                1
                                            : delivery.deliveryManDetails
                                                    ?.deliveryMan?.isActive ==
                                                1,
                                    onToggle:
                                        switchAction as void Function(bool)),
                              );
                            });
                          });
                        })
                      : isCart
                          ? Consumer<CartController>(
                              ...
                              return Padding(
                                ...
                                child: IconButton(
                                  onPressed: () {
                                    Provider.of<BottomMenuController>(context,
                                            listen: false)
                                        .selectHomePage();
                                  },
                                  icon: Stack(
