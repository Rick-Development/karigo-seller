...
class CustomEditDialogWidget extends StatefulWidget {
  const CustomEditDialogWidget({Key? key}) : super(key: key);
...
class CustomEditDialogWidgetState extends State<CustomEditDialogWidget> {
  ...
  void initState() {
    Provider.of<WalletController>(context, listen: false)
        .setMethodTypeIndex(0, notify: false);
    super.initState();
  }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Consumer<WalletController>(builder: (context, withdraw, _) {
                  return Padding(
                    ...
                    child: Column(
                      children: [
                          ...
                          child: DropdownButton<int>(
                            ...
                            items: withdraw.methodsIds.map((int? value) {
                              return DropdownMenuItem<int>(
                                ...
                                child: Text(withdraw
                                    .methodList[
                                        (withdraw.methodsIds.indexOf(value))]
                                    .methodName!),
                              );
                            }).toList(),
                            onChanged: (int? value) {
                        ...
                        if (withdraw.methodList.isNotEmpty &&
                            withdraw.methodList[withdraw.methodSelectedIndex!]
                                    .methodFields !=
                                null &&
                            withdraw.inputFieldControllerList.isNotEmpty &&
                            withdraw.methodList[withdraw.methodSelectedIndex!]
                                .methodFields!.isNotEmpty)
                          ListView.builder(
                              physics: const NeverScrollableScrollPhysics(),
                              shrinkWrap: true,
                              itemCount: withdraw
                                  .methodList[withdraw.methodSelectedIndex!]
                                  .methodFields!
                                  .length,
                        ...
                        return InkWell(
                          ...
                          onTap: () {
                            ...
                            for (TextEditingController title
                                in withdraw.inputFieldControllerList) {
                            ...
                            if (haveBlankTitle) {
                              showCustomSnackBarWidget(
                                  getTranslated(
                                      'please_fill_all_the_field', context),
                                  context,
                                  isToaster: true);
                            } else {
                              withdrawBalance();
  ...
  void withdrawBalance() async {
    ...
    if (balance.isEmpty) {
      showCustomSnackBarWidget(getTranslated('enter_balance', context), context,
          isToaster: true);
    } else if (bal >
        double.parse(PriceConverter.convertPriceWithoutSymbol(
            context,
      ...
      showCustomSnackBarWidget(
          getTranslated('minimum_amount', context), context,
          isToaster: true);
    } else if (bal <= 1) {
      showCustomSnackBarWidget(
          getTranslated('minimum_amount', context), context,
      ...
      await Provider.of<WalletController>(context, listen: false)
          .updateBalance(bal.toString(), context);
    }
  }
}
