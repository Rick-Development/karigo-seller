...
class _AttributeViewWidgetState extends State<AttributeViewWidget> {
  ...
  void _load() {
    Provider.of<AddProductController>(context, listen: false).selectedColor;
  }
    ...
    return Consumer<AddProductController>(
      builder: (context, resProvider, child) {
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  child: resProvider.attributeList!.isNotEmpty
                      ? ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return InkWell(
                              onTap: () => resProvider.toggleAttribute(
                                  context, index, widget.product),
                              child: Container(
                                width: 100,
                                ...
                                decoration: BoxDecoration(
                                  color:
                                      resProvider.attributeList![index].active
                                ...
                                child: Text(
                                  resProvider
                                      .attributeList![index].attribute.name!,
                                  maxLines: 2,
          ...
          SizedBox(
              height: resProvider.attributeList!
          ...
          widget.onlyQuantity
              ...
              : resProvider.attributeList!.isNotEmpty
                  ? ListView.builder(
                      ...
                      itemCount: resProvider.attributeList!.length,
                      itemBuilder: (context, index) {
                        return (resProvider.attributeList![index].active &&
                                index != 0)
                            ? Column(
                                ...
                                children: [
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          resProvider.attributeList![index]
                                              .attribute.name!,
                                          maxLines: 2,
                                          textAlign: TextAlign.center,
                                          style: robotoRegular.copyWith(
                                    ...
                                    SizedBox(
                                      height: 30,
                                      child: resProvider.attributeList![index]
                                              .variants.isNotEmpty
                                          ? ListView.builder(
                                              scrollDirection: Axis.horizontal,
          ...
          SizedBox(
              height: resProvider.variantTypeList.isNotEmpty
          ...
          resProvider.variantTypeList.isNotEmpty
                            ...
                            Expanded(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      Text(
                                        resProvider
                                            .variantTypeList[index].variantType,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        CustomTextFieldWidget(
                                          ...
                                          hintText: 'Ex: \$234',
                                          controller: resProvider
                                              .variantTypeList[index]
                                              .controller,
                                          focusNode: resProvider
                                              .variantTypeList[index].node,
                                          nextNode: index !=
                                                  resProvider.variantTypeList
                                                          .length -
                                                      1
                                              ? resProvider
                                                  .variantTypeList[index + 1]
                                                  .node
                                              : null,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    CustomTextFieldWidget(
                                      ...
                                      hintText: 'Ex: 345',
                                      controller: resProvider
                                          .variantTypeList[index].qtyController,
                                      focusNode: resProvider
                                          .variantTypeList[index].qtyNode,
                                      nextNode: index !=
                                              resProvider
                                                      .variantTypeList.length -
                                                  1
                                          ? resProvider
                                              .variantTypeList[index + 1].node
                                          : null,
                                      textInputAction: index !=
                                              resProvider
                                                      .variantTypeList.length -
              ...
              : const SizedBox(),
          SizedBox(
              height: resProvider.hasAttribute()
                  ? Dimensions.paddingSizeExtraSmall
                  : 0),
        ]);
      },
