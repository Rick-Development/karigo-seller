...
import 'package:karingo_seller/common/basewidgets/image_diaglog_widget.dart';
import 'package:karingo_seller/common/basewidgets/no_data_screen.dart';
import 'package:karingo_seller/features/order_details/widgets/customer_contact_widget.dart';
import 'package:karingo_seller/features/order_details/widgets/delivery_man_information_widget.dart';
import 'package:karingo_seller/features/order_details/widgets/order_product_list_item_widget.dart';
import 'package:karingo_seller/features/order_details/widgets/order_setup_widget.dart';
import 'package:karingo_seller/features/order_details/widgets/order_top_section_widget.dart';
import 'package:karingo_seller/features/order_details/widgets/payment_status_widget.dart';
import 'package:karingo_seller/features/order_details/widgets/shipping_and_biilling_widget.dart';
import 'package:karingo_seller/features/order_details/widgets/third_party_delivery_info_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Consumer<OrderController>(
          ...
          return Consumer<OrderDetailsController>(
            ...
            if (orderDetailsController.orderDetails != null) {
              coupon = orderDetailsController
                  .orderDetails![0].order!.discountAmount!;
              shipping =
                  orderDetailsController.orderDetails![0].order!.shippingCost!;
              ...
              if (orderDetailsController.orderDetails![0].order!.orderType ==
                  'POS') {
                if (orderDetailsController
                        .orderDetails![0].order!.extraDiscountType ==
                    'percent') {
                  eeDiscount = itemsPrice *
                      (orderDetailsController
                              .orderDetails![0].order!.extraDiscount! /
                          100);
                } else {
                  eeDiscount = orderDetailsController
                      .orderDetails![0].order!.extraDiscount;
                }
              }
            }
            ...
            return orderDetailsController.orderDetails != null
                ? orderDetailsController.orderDetails!.isNotEmpty
                    ? CustomScrollView(
                        slivers: [
                          SliverToBoxAdapter(
                            child: Column(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          PaymentStatusWidget(
                                              ...
                                              orderModel: orderDetailsController
                                                        ...
                                                        return InkWell(
                                                          onTap: () => showDialog(
                                                              ...
                                                              builder: (_) =>
                                                                  ImageDialogWidget(
                                                                      imageUrl:
                                                                          '${AppConstants.baseUrl}/storage/app/public/delivery-man/verification-image/${orderDetailsController.orderDetails![0].verificationImages?[index].image}')),
                                                          child: Padding(
                                                            padding: EdgeInsets.only(
                                                                left: Dimensions
                                                                    .paddingSizeSmall,
                                                                right: orderDetailsController
                                                                            .orderDetails![
                                                                                0]
                                                                            .verificationImages!
                                                                            .length ==
      ...
      bottomNavigationBar: Consumer<OrderDetailsController>(
          builder: (context, orderDetailsController, _) {
        return (orderDetailsController.orderDetails != null &&
                orderDetailsController.orderDetails![0].order!.orderType ==
                    'POS')
            ? const SizedBox.shrink()
            : Container(
                decoration: BoxDecoration(
