...
import 'package:karingo_seller/features/order/widgets/delivery_man_assign_widget.dart';

class OrderSetupWidget extends StatefulWidget {
  final Order? orderModel;
  final bool onlyDigital;
  const OrderSetupWidget({Key? key, this.orderModel, this.onlyDigital = false})
      : super(key: key);
...
class _OrderSetupWidgetState extends State<OrderSetupWidget> {
  @override
  void initState() {
    Provider.of<DeliveryManController>(Get.context!, listen: false)
  ...
  Widget build(BuildContext context) {
    ...
    String? shipping = Provider.of<SplashController>(context, listen: false)
        .configModel!
        .shippingMethod;
        ...
        child: Column(
          children: [
            Consumer<OrderDetailsController>(
              ...
              bool paymentActive = orderDetailsController.orderDetails != null
                          ...
                          widget: DropdownButtonFormField<String>(
                            ...
                            onChanged: (value) {
                              orderDetailsController.updateOrderStatus(
                                  widget.orderModel!.id, value);
                            },
                            items: orderDetailsController.orderStatusList
                  ...
                  CustomDropDownItemWidget(
                    ...
                    widget: DropdownButtonFormField<String>(
                      ...
                      onChanged: !paymentActive
                          ? null
                          : (value) {
                              orderDetailsController.setPaymentMethodIndex(
                                  value == 'paid' ? 0 : 1);
                              orderDetailsController.updatePaymentStatus(
