...
import 'package:karingo_seller/features/order_details/domain/models/order_details_model.dart';
...
class OrderedProductListItemWidget extends StatefulWidget {
  ...
  final int? index;
  final int? length;
  const OrderedProductListItemWidget(
      {Key? key,
  ...
  @override
  State<OrderedProductListItemWidget> createState() =>
      _OrderedProductListItemWidgetState();
}

class _OrderedProductListItemWidgetState
    extends State<OrderedProductListItemWidget> {
                                ...
                                if (widget.orderDetailsModel!.productDetails!
                                  ...
                                  widget.orderDetailsModel!.productDetails!
                                      ...
                                      ? _launchUrl(Uri.parse(
                                          '${Provider.of<SplashController>(context, listen: false).baseUrls!.digitalProductUrl}/${widget.orderDetailsModel!.digitalFileAfterSell}'))
                                      : _launchUrl(Uri.parse(
                                          '${Provider.of<SplashController>(context, listen: false).baseUrls!.digitalProductUrl}/${widget.orderDetailsModel!.productDetails!.digitalFileReady}'));
                                }
                              },
                              child: Container(
                                height: 38,
