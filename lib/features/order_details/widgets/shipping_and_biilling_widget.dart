...
import 'package:karingo_seller/features/order/screens/edit_address_screen.dart';
import 'package:karingo_seller/features/order/widgets/icon_with_text_row_widget.dart';
import 'package:karingo_seller/features/order_details/widgets/show_on_map_dialog_widget.dart';
                                            ...
                                            showDialog(
                                                ...
                                                builder: (_) {
                                                  return ShowOnMapDialogWidget(
                                                      billingAddressData: resProvider
                                                          .getAddressForMap(
                                                              orderModel!
                                                                  .shippingAddressData!,
                                                              orderModel!
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          ...
                          text: orderModel!
                                  .shippingAddressData?.contactPersonName ??
                              '',
                          icon: Icons.person,
                          bold: true,
                        )),
                        Expanded(
                            child: IconWithTextRowWidget(
                          text: orderModel!.shippingAddressData?.phone ?? '',
                          icon: Icons.call,
                          bold: true,
                        )),
                      ],
