...
import 'package:karingo_seller/features/settings/widgets/order_wise_shipping_card_widget.dart';
...
class OrderWiseShippingScreenState extends State<OrderWiseShippingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<ShippingController>(context, listen: false).getShippingList(
