...
import 'package:karingo_seller/features/shipping/widgets/category_wise_shipping_card_widget.dart';
...
class CategoryWiseShippingScreen extends StatefulWidget {
  ...
  @override
  State<CategoryWiseShippingScreen> createState() =>
      _CategoryWiseShippingScreenState();
}

class _CategoryWiseShippingScreenState
    extends State<CategoryWiseShippingScreen> {
  @override
  void initState() {
    Provider.of<ShippingController>(context, listen: false).setShippingCost();
    Provider.of<ShippingController>(context, listen: false)
        .iniType('category_wise');
    super.initState();
  }
            ...
            child: Consumer<ShippingController>(
              ...
              return Stack(
                children: [
                  Column(
                    children: [
                      shipProv.categoryWiseShipping != null
                          ? shipProv.categoryWiseShipping!.isNotEmpty
                              ? Expanded(
                                  child: Padding(
                                  ...
                                  child: ListView.builder(
                                      itemCount:
                                          shipProv.categoryWiseShipping!.length,
                                      itemBuilder: (context, index) {
                                        return CategoryWiseShippingCardWidget(
                                            shipProv: shipProv,
                                            index: index,
                                            category: shipProv
                                                .categoryWiseShipping![index]
                                                .category);
                                      }),
                                ))
                      ...
                      child: shipProv.isLoading
                          ...
                          : CustomButtonWidget(
                              ...
                              onTap: () {
                                ...
                                List<int> isMulti = [];
                                for (var cost
                                    in shipProv.shippingCostController) {
                                  costing.add(double.parse(
                                      cost.text.trim().toString()));
                                }
                                ids = shipProv.ids;
                                isMulti = shipProv.isMultiplyInt;
                                shipProv
                                    .setCategoryWiseShippingCost(
                                        context, ids, costing, isMulti)
                                    .then((value) {
