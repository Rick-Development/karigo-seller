...
import 'package:karingo_seller/features/refund/domain/models/refund_details_model.dart';
...
import 'package:karingo_seller/features/refund/widgets/approve_reject_widget.dart';
import 'package:karingo_seller/features/refund/widgets/customer_info_widget.dart';
import 'package:karingo_seller/features/refund/widgets/delivery_man_info_widget.dart';
import 'package:karingo_seller/features/refund/widgets/refund_pricing_widget.dart';
import 'package:karingo_seller/features/refund/widgets/refund_widget.dart';
        ...
        SingleChildScrollView(
          child: Consumer<RefundController>(builder: (context, refundReq, _) {
            if (refundReq.refundDetailsModel != null) {
              ...
              status =
                  refundReq.refundDetailsModel?.refundRequest![0].refundStatus;
            ...
            return Column(
                ...
                children: [
                  ...
                  widget.refundModel!.customer != null
                      ? CustomerInfoWidget(refundModel: widget.refundModel)
                      : Padding(
                          padding: const EdgeInsets.symmetric(
                  ...
                  (refundReq.refundDetailsModel != null &&
                          refundReq.refundDetailsModel!.deliverymanDetails !=
                              null)
                      ? DeliveryManInfoWidget(refundReq: refundReq)
                      : const SizedBox(),
                  const SizedBox(height: Dimensions.paddingSizeBottomSpace),
                ]);
          }),
        ),
        Consumer<RefundController>(builder: (context, refundReq, _) {
          return refundReq.showRejectButton
              ? Positioned(
                  bottom: 0,
                  left: 0,
                  right: 0,
                  child:
                      ApprovedAndRejectWidget(refundModel: widget.refundModel))
              : const SizedBox();
        })
      ],
    );
