...
import 'package:karingo_seller/features/refund/widgets/refund_attachment_list_widget.dart';
...
import 'package:karingo_seller/features/refund/screens/refund_details_screen.dart';

class RefundWidget extends StatelessWidget {
  final RefundModel? refundModel;
  final bool isDetails;
  const RefundWidget(
      {Key? key, required this.refundModel, this.isDetails = false})
      : super(key: key);
          ...
          : () => Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (_) => RefundDetailsScreen(
                      ...
                      orderDetailsId: refundModel!.orderDetailsId,
              ...
              Padding(
                  ...
                  child: Text(
                      DateConverter.localDateToIsoStringAMPM(
                          DateTime.parse(refundModel!.createdAt!)),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.only(top: isDetails ? 10 : 0),
                          child: Container(
                                                          ...
                                                          .copyWith(
                                                              color: refundModel!
                                                                  ...
                                                                  ? ColorResources
                                                                      .getPrimary(
                                                                          context)
                                                                  : (refundModel!.status?.toLowerCase() ==
                                                                              'approved' ||
                                                                          refundModel!.status?.toLowerCase() ==
                                                                              'refunded')
                                                                      ? ColorResources
                                              ...
                                              Row(
                                                children: [
                                                  SizedBox(
                                                    ...
                                                    width: Dimensions
                                                        .iconSizeDefault,
                                                    child: Image.asset(refundModel!
                                                                .paymentInfo ==
                                                            'cash_on_delivery'
                                                        ? Images.cashPaymentIcon
                                                        : refundModel!
                                                                    .paymentInfo ==
                                                                'pay_by_wallet'
                                                            ? Images
                              ...
                              children: [
                                Row(
                                  children: [
                                    SizedBox(
                                        width: 20,
                                        child: Image.asset(Images.reason)),
                                    const SizedBox(
                                ...
                                Padding(
                                  ...
                                  child: Text(refundModel!.refundReason!,
                    ...
                    refundModel!.images != null &&
                            refundModel!.images!.isNotEmpty &&
                            isDetails
                        ? RefundAttachmentListWidget(refundModel: refundModel)
                        : const SizedBox(),
                  ],
                ))
          ],
