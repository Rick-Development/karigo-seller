...
import 'package:karingo_seller/features/auth/domain/models/register_model.dart';
import 'package:karingo_seller/features/auth/widgets/info_field_widget.dart';
import 'package:karingo_seller/features/auth/widgets/register_successfull_dialog_widget.dart';
...
class _RegistrationScreenState extends State<RegistrationScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<AuthController>(builder: (authContext, authController, _) {
                ...
                : Container(
                    ...
                    child: (authController.selectionTabIndex == 1)
                        ? CustomButtonWidget(
                            ...
                            onTap: () {
                              if (authController.firstNameController.text
                                  .trim()
                                  .isEmpty) {
                              ...
                              } else if (authController.lastNameController.text
                                  .trim()
                                  .isEmpty) {
                                showCustomSnackBarWidget(
                                    getTranslated(
                                ...
                                showCustomSnackBarWidget(
                                    ...
                                    context,
                                    sanckBarType: SnackBarType.warning);
                              } else if (authController.sellerProfileImage ==
                                  null) {
                                showCustomSnackBarWidget(
                                    getTranslated(
                                      ...
                                      : () {
                                          if (authController.firstNameController.text
                                            ...
                                            showCustomSnackBarWidget(
                                                ...
                                                sanckBarType:
                                                    SnackBarType.warning);
                                          } else if (authController.phoneController.text.trim().length <
                                              8) {
                                            showCustomSnackBarWidget(
                                                getTranslated(
                                            ...
                                            RegisterModel registerModel = RegisterModel(
                                                ...
                                                confirmPassword: authController
                                                    ...
                                                    .text
                                                    .trim(),
                                                shopName: authController
                                                    .shopNameController.text
                                                    .trim(),
                                                shopAddress: authController
                                                    .shopAddressController.text
                                                    .trim());
                                            authController
                                                .registration(
