...
import 'package:karingo_seller/features/auth/screens/auth_screen.dart';
                ...
                Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                            width: 50, child: Image.asset(Images.successIcon)),
                      ),
                      Text(
                        getTranslated('shop_register_message1', context)!,
                        style: robotoRegular,
                      ),
                      Padding(
                        ...
                        child: Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Text(getTranslated('been_sent', context)!,
                                style: robotoRegular),
                            Padding(
                              padding:
                                  const EdgeInsets.symmetric(horizontal: 2.0),
                              child: Text(
                                  getTranslated('successfully', context)!,
                                  style: robotoMedium.copyWith(
                                      color: Colors.green[600])),
                            ),
                            Text(getTranslated('to_admin', context)!,
                                style: robotoRegular),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Text(
                          getTranslated('shop_register_message2', context)!,
                ...
                Align(
                  ...
                  child: GestureDetector(
                    ...
                    child: Padding(
                      ...
                      child:
                          SizedBox(width: 18, child: Image.asset(Images.cross)),
                    ),
                  ),
                ),
              ],
