...
import 'package:karingo_seller/common/basewidgets/custom_edit_dialog_widget.dart';
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () => showModalBottomSheet(
                            ...
                            context: context,
                            builder: (_) => const CustomEditDialogWidget()),
                        child: Container(
                          height: 40,
                          width: 250,
                          decoration: BoxDecoration(
                            ...
                            children: [
                              InkWell(
                                onTap: () => showModalBottomSheet(
                                    ...
                                    context: context,
                                    builder: (_) =>
                                        const CustomEditDialogWidget()),
                                child: Text(
                                    getTranslated(
                                        'send_withdraw_request', context)!,
