...
class DeliveryManRepository implements DeliveryManRepositoryInterface {
  ...
  Future<ApiResponse> deliveryManWithdrawList(int offset, String status) async {
    try {
      final response = await dioClient!.get(
          '${AppConstants.deliveryManWithdrawList}?limit=10&offset=$offset&status=$status');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> getDeliveryManReviewList(int offset, int? id) async {
    try {
      final response = await dioClient!.get(
          '${AppConstants.deliveryManReviewList}$id?limit=10&offset=$offset');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> deliveryManWithdrawDetails(int? id) async {
    try {
      final response =
          await dioClient!.get('${AppConstants.deliveryManWithdrawDetails}$id');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  @override
  Future<ApiResponse> deliveryManWithdrawApprovedDenied(
      int? id, String note, int approved) async {
    try {
      final response = await dioClient!
          .post(AppConstants.deliveryManWithdrawApprovedRejected, data: {
        '_method': "put",
        'id': id,
        'note': note,
        'approved': approved
  ...
  Future<ApiResponse> deliveryManSearchList(int offset, String search) async {
    try {
      final response = await dioClient!.get(
          '${AppConstants.deliveryManListUri}?limit=10&offset=$offset&search=$search');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> deliveryManDetails(int? deliveryManId) async {
    try {
      final response = await dioClient!
          .get('${AppConstants.deliveryManDetails}$deliveryManId');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  @override
  Future<ApiResponse> deliveryManOrderList(
      int offset, int? deliverymanId) async {
    try {
      final response = await dioClient!.get(
          '${AppConstants.deliveryManOrderHistory}$deliverymanId?limit=10&offset=$offset');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  @override
  Future<ApiResponse> deliveryManEarningList(
      int offset, int? deliverymanId) async {
    try {
      final response = await dioClient!.get(
          '${AppConstants.deliveryManEarning}$deliverymanId?limit=10&offset=$offset');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> assignDeliveryMan(
      int? orderId, int? deliveryManId) async {
    try {
      final response = await dioClient!.post(AppConstants.assignDeliveryManUri,
          data: {
            '_method': 'put',
            'order_id': orderId,
  ...
  Future<ApiResponse> deliveryManStatusOnOff(int? id, int status) async {
    try {
      final response = await dioClient!.post(
          AppConstants.deliveryManStatusOnOff,
  ...
  @override
  Future<ApiResponse> collectCashFromDeliveryMan(
      int? deliveryManId, String amount) async {
    try {
      if (kDebugMode) {
        print('====>id==$deliveryManId== and amount ===$amount');
      }
      final response = await dioClient!.post(
          AppConstants.collectCashFromDeliveryMan,
  ...
  Future<ApiResponse> deleteDeliveryMan(int? deliveryManId) async {
    try {
      final response = await dioClient!
          .get('${AppConstants.deleteDeliveryman}$deliveryManId');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> getDeliverymanOrderHistoryLog(int? orderId) async {
    try {
      final response = await dioClient!
          .get('${AppConstants.deliveryManOrderChangeLog}$orderId');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  @override
  Future<ApiResponse> addNewDeliveryMan(XFile? profileImage,
      List<XFile?> identityImage, DeliveryManBody deliveryManBody, String token,
      {bool isUpdate = false}) async {
    print('===DMRepo==>>$isUpdate');
    ...
    if (identityImage.isNotEmpty) {
      ...
      for (int i = 0; i < identityImage.length; i++) {
        ...
        var part = http.MultipartFile(
          'identity_image[]',
          identityImage[i]!.readAsBytes().asStream(),
          list.length,
  ...
  @override
  Future<ApiResponse> getDeliveryManCollectedCashList(
      int? id, int offset) async {
    try {
      final response = await dioClient!.get(
          '${AppConstants.deliveryManCollectedCashList}$id?limit=10&offset=$offset');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
