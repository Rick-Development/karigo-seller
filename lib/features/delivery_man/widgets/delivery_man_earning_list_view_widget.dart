...
import 'package:karingo_seller/features/delivery_man/widgets/earning_card_widget.dart';

class DeliverymanEarningListViewWidget extends StatefulWidget {
  final DeliveryMan? deliveryMan;
  final ScrollController? scrollController;
  const DeliverymanEarningListViewWidget(
      {Key? key, this.deliveryMan, this.scrollController})
      : super(key: key);

  @override
  State<DeliverymanEarningListViewWidget> createState() =>
      _DeliverymanEarningListViewWidgetState();
}

class _DeliverymanEarningListViewWidgetState
    extends State<DeliverymanEarningListViewWidget> {
  @override
      ...
      return earningProvider.deliveryManEarning != null
          ? earningProvider.deliveryManEarning!.orders!.isNotEmpty
              ? RefreshIndicator(
                  ...
                  onRefresh: () async {
                    await earningProvider.getDeliveryManEarningList(
                  ...
                  child: PaginatedListViewWidget(
                    ...
                    onPaginate: (int? offset) =>
                        earningProvider.getDeliveryManEarningList(
