...
import 'package:karingo_seller/features/delivery_man/screens/add_new_delivery_man_screen.dart';

class DeliveryManCardWidget extends StatelessWidget {
  final DeliveryMan? deliveryMan;
  final bool isDetails;
  const DeliveryManCardWidget(
      {Key? key, this.deliveryMan, this.isDetails = false})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: isDetails
          ...
          : const EdgeInsets.fromLTRB(Dimensions.paddingSizeExtraSmall, 5,
            ...
            SlidableAction(
              onPressed: (value) {
                Provider.of<DeliveryManController>(context, listen: false)
                    .deleteDeliveryMan(context, deliveryMan!.id);
              },
              backgroundColor:
            ...
            SlidableAction(
              onPressed: (value) {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (_) =>
                            AddNewDeliveryManScreen(deliveryMan: deliveryMan)));
              },
          ...
          child: Container(
            decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(
                    isDetails ? 0 : Dimensions.paddingSizeSmall),
                boxShadow: [
                  BoxShadow(
            ...
            child: Stack(
              children: [
                      ...
                      child: Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: CustomImageWidget(
                              ...
                              image:
                                  '${Provider.of<SplashController>(context, listen: false).baseUrls!.deliveryManImageUrl}/${deliveryMan!.image}'),
                        ),
                      ),
                    ),
                    Expanded(
                                  ...
                                  child: Row(
                                    children: [
                                      const Icon(Icons.star_rate_rounded,
                                          color: Colors.orange),
                                      Text(
                                        deliveryMan!.rating!.isNotEmpty
                                            ? double.parse(deliveryMan!
                                                    .rating![0].average!)
                                                .toStringAsFixed(1)
                                            : '0',
                                        style: robotoMedium,
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        borderRadius: BorderRadius.circular(
                                            Dimensions.paddingSizeExtraSmall)),
                                    child: Text(
                                      '${NumberFormat.compact().format(deliveryMan!.orders!.isNotEmpty ? deliveryMan!.orders![0].count : 0)} ${getTranslated('orders', context)}',
                                      style: robotoMedium.copyWith(
                                          color: Colors.white),
                                    ),
                                  ),
                ...
                Align(
                  alignment: Provider.of<LocalizationController>(context,
                              listen: false)
                          .isLtr
