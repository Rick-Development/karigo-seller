...
import 'package:karingo_seller/features/auth/widgets/pass_view.dart';
...
import 'package:karingo_seller/common/basewidgets/textfeild/custom_pass_textfeild_widget.dart';
import 'package:karingo_seller/common/basewidgets/textfeild/custom_text_feild_widget.dart';
import 'package:karingo_seller/features/auth/widgets/code_picker_widget.dart';
...
class DeliveryManInfoWidget extends StatefulWidget {
  ...
  const DeliveryManInfoWidget(
      {Key? key, this.isPassword = false, this.deliveryMan})
      : super(key: key);
...
class _DeliveryManInfoWidgetState extends State<DeliveryManInfoWidget> {
  ...
  void initState() {
    ...
    if (widget.deliveryMan != null && !widget.isPassword) {
      ...
      Provider.of<DeliveryManController>(context, listen: false)
          .setIdentityType(widget.deliveryMan!.identityType);
    }
              ...
              if (!widget.isPassword)
                Column(
                  children: [
                            ...
                            child: Stack(children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(
                                    Dimensions.paddingSizeSmall),
                                child: deliveryManProvider.profileImage != null
                                    ? Image.file(
                                        File(deliveryManProvider
                                            .profileImage!.path),
                                        width: 150,
                                        height: 150,
                                        fit: BoxFit.cover,
                                    ...
                                    : widget.deliveryMan != null
                                        ? FadeInImage.assetNetwork(
                                            ...
                                            image:
                                                '${Provider.of<SplashController>(context).configModel!.baseUrls!.deliveryManImageUrl}/${widget.deliveryMan!.image ?? ''}',
                                            height: 150,
                                            width: 150,
                                            fit: BoxFit.cover,
                              ...
                              Positioned(
                                ...
                                left: 0,
                                child: InkWell(
                                  onTap: () => deliveryManProvider.pickImage(
                                      true, false),
                                  child: Container(
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: DropdownButton<String>(
                          hint: deliveryManProvider.identityType == null
                              ? Text(getTranslated(
                                  'select_identity_type', context)!)
                              : Text(
                          ...
                          items: deliveryManProvider.identityTypeList
                              .map((String value) {
                          ...
                          onChanged: (val) {
                            setState(
                              () {
                                deliveryManProvider.setIdentityType(val);
                              },
                            );
                          },
                          isExpanded: true,
                    ...
                    widget.deliveryMan != null &&
                            widget.deliveryMan!.identityImage!.isNotEmpty
                        ? Padding(
                            padding: const EdgeInsets.symmetric(
                                horizontal: Dimensions.paddingSizeLarge,
                            ...
                            child: ListView.builder(
                                ...
                                itemCount:
                                    widget.deliveryMan!.identityImage!.length,
                                itemBuilder: (BuildContext context, index) {
                                  if (kDebugMode) {
                                    print(
                                        '==>image path==$baseUrl/${widget.deliveryMan!.identityImage![index]}');
                                  }
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: CustomImageWidget(
                                          ...
                                          image:
                                              '$baseUrl/${widget.deliveryMan!.identityImage![index]}',
                                        ),
                                      ),
                                    )
                                  ]);
                    ...
                    Padding(
                      ...
                      child: ListView.builder(
                          ...
                          physics: const NeverScrollableScrollPhysics(),
                          itemCount:
                              deliveryManProvider.identityImages.length + 1,
                          itemBuilder: (BuildContext context, index) {
                            return index ==
                                    deliveryManProvider.identityImages.length
                                ? GestureDetector(
                                    onTap: () => deliveryManProvider.pickImage(
                                      false,
                                      false,
                                        ...
                                        child: Container(
                                          ...
                                          child: ClipRRect(
                                            borderRadius: const BorderRadius
                                                .all(Radius.circular(Dimensions
                                                    .paddingSizeExtraSmall)),
                                            child: Image.file(
                                              File(deliveryManProvider
                  ...
                  children: [
                    Container(
                        ...
                        child: CustomTextFieldWidget(
                          ...
                          hintText:
                              '${deliveryManProvider.countryDialCode} ${deliveryManProvider.phoneController.text}',
                        )),
                    Container(
                        margin: const EdgeInsets.only(
                            left: Dimensions.paddingSizeLarge,
                    ...
                    Container(
                        ...
                        child: CustomPasswordTextFieldWidget(
                            ...
                            controller:
                                deliveryManProvider.confirmPasswordController)),
