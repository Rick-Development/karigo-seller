...
class DeliveryManReviewCardWidget extends StatelessWidget {
  ...
  const DeliveryManReviewCardWidget({Key? key, required this.reviewModel})
      : super(key: key);
                  ...
                  ClipRRect(
                      ...
                      child: SizedBox(
                          ...
                          child: CustomImageWidget(
                              image:
                                  "$baseUrl/${reviewModel.customer!.image}"))),
                const SizedBox(
                    ...
                    child: Column(
                      ...
                      Padding(
                          ...
                          child: Row(children: [
                            ...
                            Text(reviewModel.orderId.toString(),
                                style: robotoBold)
                          ]))
                    ])),
              ],
