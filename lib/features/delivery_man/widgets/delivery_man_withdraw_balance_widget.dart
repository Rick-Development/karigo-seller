...
import 'package:karingo_seller/features/delivery_man/screens/withdraw/delivery_man_collect_cash_widget.dart';

class DeliveryManWithdrawBalanceWidget extends StatelessWidget {
  final DeliveryManController? deliveryManProvider;
  const DeliveryManWithdrawBalanceWidget({Key? key, this.deliveryManProvider})
      : super(key: key);
  @override
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Consumer<ProfileController>(builder: (context, seller, child) {
            return Container(
              height: MediaQuery.of(context).size.width / 2.5,
              width: MediaQuery.of(context).size.width,
              padding: const EdgeInsets.symmetric(
                        ...
                        children: [
                          ...
                          Text(
                              PriceConverter.convertPrice(
                                  context,
                                  deliveryManProvider!.deliveryManDetails
                                              ?.deliveryMan?.wallet !=
                                          null
                                      ? double.parse(deliveryManProvider!
                                          .deliveryManDetails!
                                          .deliveryMan!
                                          .wallet!
                                          .cashInHand!)
                              ...
                              style: robotoBold.copyWith(
                                  color: Colors.white,
                                  fontSize:
                                      Dimensions.fontSizeWithdrawableAmount)),
                        ],
                      ),
                      const SizedBox(
                            ...
                            onTap: () => showModalBottomSheet(
                                ...
                                builder: (_) =>
                                    CollectedCashFromDeliveryManDialog(
                                      deliveryManId: deliveryManProvider!
                                          .deliveryManDetails?.deliveryMan?.id,
                                      totalCashInHand: deliveryManProvider!
                                                  .deliveryManDetails
                                                  ?.deliveryMan
                                                  ?.wallet !=
                                              null
