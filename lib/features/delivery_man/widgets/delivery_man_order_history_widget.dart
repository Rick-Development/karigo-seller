...
import 'package:karingo_seller/features/delivery_man/widgets/order_change_log_widget.dart';
import 'package:karingo_seller/features/order_details/screens/order_details_screen.dart';

class DeliveryManOrderHistoryWidget extends StatelessWidget {
  final Order orderModel;
  final int? index;
  const DeliveryManOrderHistoryWidget(
      {Key? key, required this.orderModel, this.index})
      : super(key: key);
              ...
              children: [
                ...
                InkWell(
                  onTap: () => Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (_) =>
                              OrderDetailsScreen(orderId: orderModel.id))),
                  child: Container(
                    decoration: BoxDecoration(
                        color: Theme.of(context).cardColor,
                        borderRadius: const BorderRadius.only(
