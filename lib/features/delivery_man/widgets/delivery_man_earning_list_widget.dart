...
import 'package:karingo_seller/features/delivery_man/screens/delivery_man_earning_view_all_screen.dart';
import 'package:karingo_seller/features/delivery_man/widgets/delivery_man_earning_list_view_widget.dart';

class DeliveryManEarningListWidget extends StatefulWidget {
  final DeliveryMan? deliveryMan;
  const DeliveryManEarningListWidget({Key? key, this.deliveryMan})
      : super(key: key);
...
class EarningItemCard extends StatelessWidget {
  ...
  final String? title;
  final String? icon;
  const EarningItemCard({Key? key, this.amount, this.title, this.icon})
      : super(key: key);
