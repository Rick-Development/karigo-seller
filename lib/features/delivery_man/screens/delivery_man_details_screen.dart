...
import 'package:karingo_seller/features/delivery_man/screens/collect_cash_from_delivery_man_screen.dart';
import 'package:karingo_seller/features/delivery_man/widgets/delivery_man_earning_list_widget.dart';
import 'package:karingo_seller/features/delivery_man/screens/delivery_man_order_history_screen.dart';
import 'package:karingo_seller/features/delivery_man/widgets/delivery_man_review_list_widget.dart';
import 'package:karingo_seller/features/delivery_man/screens/delivery_man_overview_screen.dart';
...
class _DeliveryManDetailsScreenState extends State<DeliveryManDetailsScreen>
  ...
  void initState() {
    ...
    Provider.of<DeliveryManController>(context, listen: false)
        .getDeliveryManOrderList(context, 1, widget.deliveryMan!.id);
    Provider.of<DeliveryManController>(context, listen: false)
        .getDeliveryManEarningList(context, 1, widget.deliveryMan!.id);
    Provider.of<DeliveryManController>(context, listen: false)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<AuthController>(builder: (authContext, authProvider, _) {
        return Column(children: [
          ...
          Expanded(
            ...
            children: [
              ...
              CollectedCashFromDeliveryManScreen(
