...
import 'package:karingo_seller/features/emergency_contract/screens/emergency_contact_screen.dart';
import 'package:karingo_seller/features/delivery_man/screens/add_new_delivery_man_screen.dart';
import 'package:karingo_seller/features/delivery_man/screens/delivery_man_list_screen.dart';
import 'package:karingo_seller/features/delivery_man/screens/withdraw/withdraw_screen.dart';
...
class DeliveryManSetupCard extends StatelessWidget {
  ...
  final String? title;
  final Widget? widget;
  const DeliveryManSetupCard({Key? key, this.icon, this.title, this.widget})
      : super(key: key);
