...
import 'package:karingo_seller/features/delivery_man/screens/withdraw/withdraw_list.dart';
...
class WithdrawTypeButton extends StatelessWidget {
  final String? text;
  final int index;
  const WithdrawTypeButton({Key? key, required this.text, required this.index})
      : super(key: key);
