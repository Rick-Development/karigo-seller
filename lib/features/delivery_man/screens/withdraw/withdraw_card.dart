...
class WithdrawCardWidget extends StatelessWidget {
  ...
  const WithdrawCardWidget(
      {Key? key, this.withdraw, this.index, this.isDetails = false})
      : super(key: key);
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        PriceConverter.convertPrice(context, withdraw!.amount),
              ...
              Padding(
                ...
                child: Text(
                    DateConverter.localDateToIsoStringAMPM(
                        DateTime.parse(withdraw!.createdAt!)),
              ...
              withdraw!.transactionNote != null
                  ? Padding(
                      padding: const EdgeInsets.fromLTRB(
                          ...
                          Dimensions.paddingSizeSmall),
                      child: Text(
                        '${getTranslated('note', context)} : ${withdraw!.transactionNote}',
