...
class CollectedCashFromDeliveryManDialog extends StatefulWidget {
  ...
  const CollectedCashFromDeliveryManDialog(
      {Key? key, this.totalCashInHand, this.deliveryManId})
      : super(key: key);
  @override
  CollectedCashFromDeliveryManDialogState createState() =>
      CollectedCashFromDeliveryManDialogState();
}

class CollectedCashFromDeliveryManDialogState
    extends State<CollectedCashFromDeliveryManDialog> {
          ...
          child: Consumer<DeliveryManController>(
            ...
            return Container(
              padding: const EdgeInsets.fromLTRB(Dimensions.paddingSizeDefault,
                  100, Dimensions.paddingSizeDefault, 0),
              child: Column(
                children: [
                  Row(
                      ...
                      IntrinsicWidth(
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              isCollapsed: true,
                              hintText: "Ex: 500",
                              hintStyle: robotoBold.copyWith(fontSize: 20)),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                            '${getTranslated('available_balance', context)} : ',
                            style: robotoRegular.copyWith(
                                color: Theme.of(context).hintColor)),
                        Text(
                            PriceConverter.convertPrice(
                                context, widget.totalCashInHand ?? 0),
                            style: robotoRegular.copyWith(
                                color: Theme.of(context).hintColor,
                            ...
                            onTap: () {
                              ...
                              if (amount.isEmpty) {
                                ...
                                showCustomSnackBarWidget(
                                    getTranslated(
                                        'amount_is_required', context),
                                    context,
                                    isToaster: true,
                                    sanckBarType: SnackBarType.warning);
                              } else if ((widget.totalCashInHand != null &&
                                      widget.totalCashInHand! <
                                          double.parse(amount)) ||
                                  widget.totalCashInHand == null ||
                                  widget.totalCashInHand! == 0) {
                                Navigator.pop(context);
                                showCustomSnackBarWidget(
                                    getTranslated(
                                        'receive_amount_cantbe_more_then_cash_in_hand',
                                        context),
                                    context,
                                    isToaster: true,
                                    sanckBarType: SnackBarType.warning);
                              } else {
                                deliverymanProvider.collectCashFromDeliveryMan(
                                    context, widget.deliveryManId, amount);
                              }
                            },
                          ),
                        )
