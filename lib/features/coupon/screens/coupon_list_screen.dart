...
import 'package:karingo_seller/features/coupon/screens/add_new_coupon_screen.dart';
import 'package:karingo_seller/features/coupon/widgets/coupon_card_widget.dart';
...
class _CouponListScreenState extends State<CouponListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<CouponController>(builder: (context, couponProvider, _) {
        return couponProvider.couponModel != null
            ? (couponProvider.couponModel!.coupons != null &&
                    couponProvider.couponModel!.coupons!.isNotEmpty)
                ? SingleChildScrollView(
                    ...
                    child: PaginatedListViewWidget(
                      ...
                      itemView: ListView.builder(
                          ...
                          itemCount:
                              couponProvider.couponModel?.coupons?.length,
                          shrinkWrap: true,
                          itemBuilder: (context, index) {
                            return CouponCardWidget(
                              coupons:
                                  couponProvider.couponModel?.coupons?[index],
                              index: index,
                            );
                          }),
                    ),
