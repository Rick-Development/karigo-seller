...
import 'package:karingo_seller/common/basewidgets/custom_date_picker_widget.dart';
import 'package:karingo_seller/common/basewidgets/custom_drop_down_item_widget.dart';
import 'package:karingo_seller/common/basewidgets/custom_field_with_title_widget.dart';
...
class _AddNewCouponScreenState extends State<AddNewCouponScreen> {
  ...
  void initState() {
    ...
    if (update) {
      ...
      Provider.of<CouponController>(context, listen: false).startDate =
          DateTime.parse(widget.coupons!.startDate!);
      Provider.of<CouponController>(context, listen: false).endDate =
          DateTime.parse(widget.coupons!.expireDate!);
    }
    Provider.of<CouponController>(context, listen: false)
        .getCouponCustomerList(context, '');
    if (Provider.of<CouponController>(context, listen: false)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<CouponController>(builder: (context, coupon, _) {
              ...
              if (coupon.discountTypeName == 'percentage')
                CustomFieldWithTitleWidget(
                    ...
                    customTextField: CustomTextFieldWidget(
                        ...
                        hintText:
                            getTranslated('minimum_purchase_hint', context))),
      ...
      bottomNavigationBar: Container(
          ...
          child: Consumer<CouponController>(builder: (context, coupon, _) {
            return Consumer<CartController>(builder: (context, customer, _) {
              return Padding(
                padding: const EdgeInsets.symmetric(
                    horizontal: Dimensions.paddingSizeDefault,
