      ...
      children: [
        ...
        Provider.of<SplashController>(context, listen: false)
            ...
            ? SectionItemWidget(
                ...
                onTap: () {
                  if (Provider.of<ShippingController>(context, listen: false)
                          .selectedShippingType ==
                      "category_wise") {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (_) => const CategoryWiseShippingScreen()));
                  } else if (Provider.of<ShippingController>(context,
                              listen: false)
                          .selectedShippingType ==
                      "order_wise") {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (_) => const OrderWiseShippingScreen()));
                  } else {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (_) => const ProductWiseShippingWidget()));
                  }
                },
              )
            : const SizedBox(),
