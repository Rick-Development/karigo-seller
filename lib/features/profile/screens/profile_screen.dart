...
import 'package:karingo_seller/helper/country_code_helper.dart';
...
class ProfileScreenState extends State<ProfileScreen> {
  ...
  _updateUserAccount() async {
    ...
    if (Provider.of<ProfileController>(context, listen: false)
      ...
      ProfileInfoModel updateUserInfoModel =
      ...
      ProfileInfoModel bank =
          Provider.of<BankInfoController>(context, listen: false).bankInfo!;
          ...
          builder: (context, profile, child) {
            if (_firstNameController.text.isEmpty ||
              ...
              String phoneNumberOnly = CountryCodeHelper.extractPhoneNumber(
                  countryCode, profile.userInfoModel!.phone!);
                        ...
                        ClipRRect(
                          ...
                          child: file == null
                              ? CustomImageWidget(
                                  ...
                                  fit: BoxFit.cover,
                                  image:
                                      '${Provider.of<SplashController>(context, listen: false).baseUrls!.sellerImageUrl}/${profile.userInfoModel!.image ?? ''}')
                              : Image.file(file!,
