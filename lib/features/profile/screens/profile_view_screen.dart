...
import 'package:karingo_seller/features/profile/screens/profile_screen.dart';
import 'package:karingo_seller/features/profile/widgets/theme_changer_widget.dart';
...
class ProfileScreenViewState extends State<ProfileScreenView> {
  ...
  void initState() {
    super.initState();
    if (Provider.of<ProfileController>(context, listen: false).userInfoModel ==
        null) {
                    ...
                    children: [
                      Expanded(
                          child: InfoItem(
                              ...
                              title: 'products',
                              amount: profile.userInfoModel!.productCount
                                  .toString())),
                      const SizedBox(
