...
import 'package:karingo_seller/features/product/screens/product_list_view_screen.dart';
import 'package:karingo_seller/features/product/widgets/top_most_product_card_widget.dart';

class MostPopularProductScreen extends StatelessWidget {
  final bool isMain;
  const MostPopularProductScreen({Key? key, this.isMain = false})
      : super(key: key);
                    ...
                    child: Row(
                      children: [
                        SizedBox(
                            ...
                            child: Image.asset(Images.popularProductIcon)),
                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                        Expanded(
                          child: TitleRowWidget(
                              color: Colors.white,
                              title:
                                  '${getTranslated('most_popular_products', context)}',
                              isPopular: true,
