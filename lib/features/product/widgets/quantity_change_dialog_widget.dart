...
class QuantityUpdateDialogWidget extends StatefulWidget {
  ...
  const QuantityUpdateDialogWidget(
      {Key? key,
      this.title,
      required this.onYesPressed,
      this.note,
      this.product,
      this.stockQuantityController})
      : super(key: key);

  @override
  State<QuantityUpdateDialogWidget> createState() =>
      _QuantityUpdateDialogWidgetState();
}

class _QuantityUpdateDialogWidgetState
    extends State<QuantityUpdateDialogWidget> {
  int addColor = 0;
  ...
  void initState() {
    _load();
    widget.stockQuantityController!.text =
  ...
  Widget build(BuildContext context) {
    return Dialog(
        ...
        child: Consumer<AddProductController>(
          ...
          if (Provider.of<AddProductController>(context, listen: false)
                      .attributeList !=
                  null &&
              Provider.of<AddProductController>(context, listen: false)
                  .attributeList!
                        ...
                        child:
                          ...
                          resProvider.attributeList != null
                              ? AttributeViewWidget(
                                  ...
                                  colorOn: resProvider.attributeList![0].active,
                                  onlyQuantity: true)
                        ...
                        child: GestureDetector(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.all(
                                Dimensions.paddingSizeDefault),
                            child: SizedBox(
                                width: 18, child: Image.asset(Images.cross)),
                          ),
                        ),
                      ),
                    ],
