...
import 'package:karingo_seller/features/barcode/screens/bar_code_generator_screen.dart';
import 'package:karingo_seller/features/product/widgets/quantity_change_dialog_widget.dart';

class StockOutProductWidget extends StatefulWidget {
  final Product productModel;
  const StockOutProductWidget({Key? key, required this.productModel})
      : super(key: key);
                            ...
                            showDialog(
                              ...
                              builder: (BuildContext context) {
                                return QuantityUpdateDialogWidget(
                                    ...
                                    onYesPressed: () {
                                      if (_stockQuantityController.text
                                          .toString()
                                          .isEmpty) {
