...
import 'package:karingo_seller/features/shop/domain/models/shop_model.dart';
...
class ShopUpdateScreenState extends State<ShopUpdateScreen> {
  ...
  _updateShop() async {
    ...
    if (Provider.of<ShopController>(context, listen: false).shopModel!.name ==
        ...
        file == null &&
        Provider.of<AuthController>(context, listen: false).shopBanner ==
            null &&
        Provider.of<AuthController>(context, listen: false).secondaryBanner ==
            null &&
        Provider.of<AuthController>(context, listen: false).offerBanner ==
            null) {
      ...
      showCustomSnackBarWidget(
          getTranslated('enter_contact_number', context), context,
          sanckBarType: SnackBarType.warning);
    } else if (address.isEmpty) {
      showCustomSnackBarWidget(getTranslated('enter_address', context), context,
          sanckBarType: SnackBarType.warning);
    } else {
      ShopModel updateShopModel =
          Provider.of<ShopController>(context, listen: false).shopModel!;
      ...
      await Provider.of<ShopController>(context, listen: false)
          .updateShopInfo(updateShopModel: updateShopModel, file: file);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          CustomAppBarWidget(title: getTranslated('shop_settings', context)),
      key: _scaffoldKey,
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(getTranslated('shop_name', context)!,
                              ...
                              Text(getTranslated('contact_number', context)!,
                                  style: titilliumRegular),
                              const SizedBox(
                                  height: Dimensions.paddingSizeSmall),
                              CustomTextFieldWidget(
                                      ...
                                      ClipRRect(
                                          ...
                                          child: file == null
                                              ? CustomImageWidget(
                                                  ...
                                                  width: 140,
                                                  image:
                                                      '${Provider.of<SplashController>(context, listen: false).baseUrls!.shopImageUrl}/${shop.shopModel!.image}')
                                              : Image.file(file!,
                                                  width: 100,
                                                  height: 100,
                                                  fit: BoxFit.cover)),
                                    ...
                                    child: authProvider.shopBanner != null
                                        ...
                                        : SizedBox(
                                            ...
                                            child: CustomImageWidget(
                                                image:
                                                    '${Provider.of<SplashController>(context, listen: false).baseUrls!.shopImageUrl}/banner/${shop.shopModel!.banner}'))),
                                Positioned(
                                  bottom: 0,
                                  right: 0,
                                  top: 0,
                                  ...
                                  child: DottedBorder(
                                    ...
                                    child: Stack(children: [
                                      ClipRRect(
                                        borderRadius: BorderRadius.circular(
                                            Dimensions.paddingSizeSmall),
                                        child: authProvider.secondaryBanner !=
                                                null
                                            ? Image.file(
                                                File(authProvider
                                                    .secondaryBanner!.path),
                                                width: MediaQuery.of(context)
                                                        .size
                                                        .width -
                                                    40,
                                            ...
                                            : SizedBox(
                                                ...
                                                child: CustomImageWidget(
                                                    image:
                                                        '${Provider.of<SplashController>(context, listen: false).baseUrls!.shopImageUrl}/banner/${shop.shopModel!.bottomBanner}'),
                                              ),
                                      ),
                                      Positioned(
                                        bottom: 0,
                                    ...
                                    child: DottedBorder(
                                      ...
                                      child: Stack(children: [
                                        ClipRRect(
                                            borderRadius: BorderRadius.circular(
                                                Dimensions.paddingSizeSmall),
                                            child: authProvider.offerBanner != null
                                                ? Image.file(
                                                    File(authProvider.offerBanner!
                                                        .path),
                                                    width: MediaQuery.of(context)
                                                            .size
                                                            .width -
                                                ...
                                                : SizedBox(
                                                    ...
                                                    child: CustomImageWidget(
                                                        image:
                                                            '${Provider.of<SplashController>(context, listen: false).baseUrls!.shopImageUrl}/banner/${shop.shopModel!.offerBanner}'))),
                                        Positioned(
                                          bottom: 0,
                                          right: 0,
                                          top: 0,
