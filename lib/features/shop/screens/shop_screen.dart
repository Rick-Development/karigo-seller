...
import 'package:karingo_seller/common/basewidgets/custom_toast.dart';
...
import 'package:karingo_seller/features/shop/widgets/shop_banner_widget.dart';
import 'package:karingo_seller/features/shop/widgets/shop_information_widget.dart';
import 'package:karingo_seller/features/shop/widgets/vacation_dialog_widget.dart';
...
class ShopScreenState extends State<ShopScreen> {
  ...
  @override
  void initState() {
    freeDeliveryOn = Provider.of<ProfileController>(context, listen: false)
            .userInfoModel!
  ...
  Widget build(BuildContext context) {
    ...
    sellerId = Provider.of<ProfileController>(context, listen: false)
        .userInfoModel!
        .id
        .toString();
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: Consumer<ShopController>(builder: (context, shopInfo, child) {
...
class ShopSettingWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Consumer<ShopController>(builder: (context, shop, _) {
      return Container(
