...
class ShopController extends ChangeNotifier {
  ...
  Future<void> updateShopInfo(
    ...
    http.StreamedResponse response = await shopServiceInterface.updateShop(
        shopModel!,
        file,
        Provider.of<AuthController>(Get.context!, listen: false).shopBanner,
        Provider.of<AuthController>(Get.context!, listen: false)
            .secondaryBanner,
        Provider.of<AuthController>(Get.context!, listen: false).offerBanner,
  ...
  Future<void> shopVacation(BuildContext context, String? startDate,
    ...
    _isLoading = true;
    notifyListeners();
    ApiResponse apiResponse = await shopServiceInterface.vacation(
