...
import 'package:karingo_seller/features/shop/screens/shop_update_screen.dart';
                              ...
                              Container(
                                  ...
                                  child: ClipRRect(
                                      ...
                                      child: CustomImageWidget(
                                          image:
                                              '${Provider.of<SplashController>(context, listen: false).baseUrls!.shopImageUrl}/${resProvider!.shopModel?.image}'))),
                              const SizedBox(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        ...
                                        style: robotoRegular.copyWith(
                                            color:
                                                ColorResources.getSubTitleColor(
                                                    context)),
                                        maxLines: 2,
                                        overflow: TextOverflow.ellipsis,
                                        softWrap: false,
                      ...
                      return Consumer<ProfileController>(
                        ...
                        return Row(
                          ...
                          children: [
                            Expanded(
                              child: ShopInfoMenu(
                                count: resProvider.shopModel!.ratting!,
                                title: 'ratting',
                                icon: Images.rattingIcon,
                                ratting: true,
                              ),
                            ),
                            const SizedBox(
                            ...
                            Expanded(
                              child: ShopInfoMenu(
                                count: double.parse(resProvider
                                    .shopModel!.rattingCount!
                                    .toString()),
                                title: 'reviews',
                            ...
                            Expanded(
                              child: ShopInfoMenu(
                                count: double.parse(profile
                                    .userInfoModel!.productCount
                                    .toString()),
                                title: 'products',
                                icon: Images.product,
                              ),
          ...
          child: Column(
            ...
            children: [
              ratting
                  ...
                  : Text(
                      NumberFormat.compact().format(count).padLeft(2, '0'),
                      style: robotoBold.copyWith(
                          color: Theme.of(context).primaryColor,
                          fontSize: Dimensions.fontSizeMaxLarge),
                    ),
              Text(
                ...
                style: robotoRegular.copyWith(
                    color: ColorResources.getSubTitleColor(context),
        ...
        Positioned(
          child: Align(
            ...
            child: Padding(
              ...
              child: SizedBox(width: 15, child: Image.asset(icon)),
            ),
          ),
        ),
      ],
