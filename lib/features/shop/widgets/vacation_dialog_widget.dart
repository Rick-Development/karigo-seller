...
import 'package:karingo_seller/features/shop/widgets/vacation_calender_widget.dart';
...
class VacationDialogWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Dialog(
        ...
        child: Consumer<ShopController>(builder: (context, shop, _) {
          return SizedBox(
            width: 500,
            child: Padding(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text(getTranslated(
                            'please_select_vacation_date_range', context)!),
                      ],
                    ),
                  ),
                  InkWell(
                    ...
                    onTap: () => showDialog(
                        context: context,
                        builder: (_) => VacationCalenderWidget()),
                    child: Padding(
                      padding: const EdgeInsets.only(
