...
import 'package:karingo_seller/features/emergency_contract/domain/models/emergency_contact_model.dart';
...
import 'package:karingo_seller/features/emergency_contract/widgets/add_emergency_contact_widget.dart';
import 'package:url_launcher/url_launcher.dart';

class EmergencyContactCardWidget extends StatelessWidget {
  final ContactList? contactList;
  final int? index;
  const EmergencyContactCardWidget({Key? key, this.contactList, this.index})
      : super(key: key);
    ...
    return Consumer<EmergencyContactController>(
      ...
      return Padding(
        padding: const EdgeInsets.fromLTRB(Dimensions.paddingSizeExtraSmall, 0,
            Dimensions.paddingSizeExtraSmall, Dimensions.paddingSizeMedium),
        child: Slidable(
          ...
          startActionPane: ActionPane(
            ...
            children: [
              SlidableAction(
                onPressed: (value) {
                  emergencyContactProvider.deleteEmergencyContact(
                      context, contactList!.id);
                },
                backgroundColor:
              ...
              SlidableAction(
                onPressed: (value) {
                  showDialog(
                      context: context,
                      builder: (_) {
                        return AddEmergencyContactWidget(
                          index: index,
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color: ColorResources
                                            .getEmergencyContactColor(context),
                        ...
                        return FlutterSwitch(
                          ...
                          onToggle: (value) {
                            emergencyContactProvider
                                .statusOnOffEmergencyContact(context,
                                    contactList!.id, value ? 1 : 0, index);
                          },
                        );
                      }),
                    ],
