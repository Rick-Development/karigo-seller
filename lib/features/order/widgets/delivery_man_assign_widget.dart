...
class DeliveryManAssignWidget extends StatefulWidget {
  ...
  const DeliveryManAssignWidget(
      {Key? key, this.orderType, this.orderModel, this.orderId})
      : super(key: key);

  @override
  State<DeliveryManAssignWidget> createState() =>
      _DeliveryManAssignWidgetState();
}

class _DeliveryManAssignWidgetState extends State<DeliveryManAssignWidget> {
  final TextEditingController _thirdPartyShippingNameController =
      TextEditingController();
  final TextEditingController _thirdPartyShippingIdController =
      TextEditingController();
  ...
  void initState() {
    ...
    if (widget.orderModel!.expectedDeliveryDate != null) {
      ...
      print(
          '=======ExpactedDeliveryDate====>>${widget.orderModel!.expectedDeliveryDate!}');
    }

    if (widget.orderModel!.thirdPartyServiceName != null) {
      _thirdPartyShippingNameController.text =
          widget.orderModel!.thirdPartyServiceName!;
    }
    if (widget.orderModel!.thirdPartyTrackingId != null) {
      _thirdPartyShippingIdController.text =
          widget.orderModel!.thirdPartyTrackingId!;
    }
    if (widget.orderModel!.deliveryType != null) {
      if (widget.orderModel!.deliveryType == 'self_delivery') {
        Provider.of<DeliveryManController>(context, listen: false)
            .setDeliveryTypeIndex(1, false);
      } else {
        Provider.of<DeliveryManController>(context, listen: false)
            .setDeliveryTypeIndex(2, false);
      }
    }
  ...
  Widget build(BuildContext context) {
    return Consumer<DeliveryManController>(builder: (context, delivery, _) {
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Container(
                        ...
                        child: DropdownButton<String>(
                          value: delivery.selectedDeliveryTypeIndex == 0
                          ...
                          onChanged: (String? newValue) {
                            delivery.setDeliveryTypeIndex(
                                newValue == 'select_delivery_type'
                                    ? 0
                                    : newValue == 'by_self_delivery_man'
                                        ? 1
                                        : 2,
                                true);
                          },
                          items: delivery.deliveryTypeList
                  ...
                  delivery.selectedDeliveryTypeIndex == 1
                      ? Padding(
                          ...
                          child: widget.orderType == 'POS'
                              ? const SizedBox()
                              : Consumer<DeliveryManController>(
                                  builder: (context, deliveryMan, child) {
                                  return Column(
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                    children: [
                                      Text(
                                        getTranslated('deliveryman', context)!,
                                        style: robotoRegular,
                                      ),
                                      const SizedBox(
                                        height: Dimensions.paddingSizeSmall,
                                      ...
                                      Text(
                                        getTranslated(
                                            'expected_delivery_date', context)!,
                                        style: robotoRegular,
                                      ),
                                      const SizedBox(
                                          height: Dimensions.paddingSizeSmall),
                                        ...
                                        return InkWell(
                                          onTap: () {
                                            orderProvider
                                              ...
                                              String expectedDate = orderProvider
                                                          .startDate !=
                                                      null
                                                  ? orderProvider.dateFormat
                                              ...
                                              String deliveryCharge =
                                                  _deliveryManCharge.text;

                                              orderProvider.setDeliveryCharge(
                                                  orderId: widget.orderId,
                                                  deliveryCharge:
                                                      deliveryCharge,
                                                  deliveryDate: dateForDelivery,
                                                  context: context);
                                            });
                                          },
                                          child: CustomTextFieldWidget(
                                            hintText: widget.orderModel!
                                                    .expectedDeliveryDate ??
                                                getTranslated(
                                                    'expected_delivery_date',
                                                    context),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            CustomTextFieldWidget(
                                              ...
                                              controller:
                                                  _thirdPartyShippingNameController,
                                              focusNode:
                                                  _thirdPartyShippingNameNode,
                                              nextNode:
                                                  _thirdPartyShippingIdNode,
                                              textInputAction:
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            CustomTextFieldWidget(
                                              ...
                                              border: true,
                                              controller:
                                                  _thirdPartyShippingIdController,
                                              focusNode:
                                                  _thirdPartyShippingIdNode,
                                              textInputAction:
                                              ...
                                              onTap: () {
                                                ...
                                                if (serviceName.isEmpty) {
                                                  showCustomSnackBarWidget(
                                                      getTranslated(
                                                          'delivery_service_provider_name_required',
                                                          context),
                                                      context);
                                                } else {
                                                  order
                                                      .assignThirdPartyDeliveryMan(
                                                          context,
                                                          serviceName,
                                                          trackingId,
