...
import 'package:karingo_seller/features/order/screens/select_location_screen.dart';
...
class EditAddressScreenState extends State<EditAddressScreen> {
  ...
  void initState() {
    ...
    print('===Latitute===>>${widget.lat}');
    print('===Longititute===>>${widget.lng}');
    ...
    Provider.of<LocationController>(context, listen: false)
        .updateInitialPosition(LatLng(double.parse(widget.lat.toString()),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Consumer<OrderController>(builder: (context, orderProvider, _) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomTextFieldWidget(
                      ...
                      nextNode: _cityNode,
                      controller:
                          locationProvider.locationTextEditingController),
                  const SizedBox(height: Dimensions.paddingSizeDefault),
                  ...
                  Container(
                      ...
                      child: CustomButtonWidget(
                        ...
                        onTap: () {
                          ...
                          String address = locationProvider
