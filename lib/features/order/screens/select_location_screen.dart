...
import 'package:karingo_seller/features/order/widgets/location_search_dialog_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<LocationController>(
        ...
        print(
            '===PositionLat==111=>${locationProvider.position.latitude}====PositionLong==111==>${locationProvider.position.longitude}');
        return Stack(
