...
class POSProductWidget extends StatefulWidget {
  ...
  const POSProductWidget({Key? key, required this.productModel, this.index})
      : super(key: key);
            ...
            onTap: () {
              if (widget.productModel.variation!.isNotEmpty) {
                showModalBottomSheet(
                    ...
                    builder: (con) =>
                        CartBottomSheetWidget(product: widget.productModel));
              }
            },
            child: Stack(
              children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              getTranslated(
                                  widget.productModel.productType, context)!,
                                    ...
                                    ? Center(
                                        ...
                                        padding: const EdgeInsets.symmetric(
                                            horizontal:
                                                Dimensions.paddingSizeSmall),
                                        child: Text(
                                            product.cartQuantity[widget.index!]
                                                .toString(),
                                            style: robotoRegular.copyWith()),
                                      ))
                                    : const SizedBox(),
