...
class CartBottomSheetWidget extends StatefulWidget {
  ...
  const CartBottomSheetWidget({Key? key, required this.product, this.callback})
      : super(key: key);
        ...
        Container(
          ...
          child: Consumer<ProductController>(
            builder: (ctx, productProvider, child) {
              ...
              String? variantName = widget.product!.colors!.isNotEmpty
                  ? widget.product!.colors![productProvider.variantIndex!].name
                  : null;
                              ...
                              Container(
                                ...
                                child: ClipRRect(
                                    ...
                                    child: CustomImageWidget(
                                        image:
                                            '${Provider.of<SplashController>(context, listen: false).baseUrls!.productThumbnailUrl}/${widget.product!.thumbnail}')),
                              ),
                              const SizedBox(
                    ...
                    CustomButtonWidget(
                        btnTxt: getTranslated(
                            stock! < widget.product!.minimumOrderQty! &&
                                ...
                                : 'add_to_cart',
                            context),
                        onTap: stock < widget.product!.minimumOrderQty! &&
                                widget.product!.productType == "physical"
                            ? null
                            : () {
                                if (stock! >=
