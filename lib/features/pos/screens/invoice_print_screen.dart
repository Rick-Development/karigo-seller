...
class _InVoicePrintScreenState extends State<InVoicePrintScreen> {
  ...
  Future _printReceiveTest() async {
    ...
    bytes += generator.row([
      PosColumn(
        text:
            '${getTranslated('invoice', Get.context!)!.toUpperCase()}#${widget.orderId}',
        width: 6,
    ...
    bytes += generator.row([
      PosColumn(
        text: DateConverter.dateTimeStringToMonthAndTime(
    ...
    bytes += generator.text(
        '...............................................................',
        styles: const PosStyles(align: PosAlign.center));
    bytes += generator.text(getTranslated('thank_you', Get.context!)!,
        styles: const PosStyles(align: PosAlign.center));
    bytes += generator.text(
      ' ',
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(
        title: getTranslated('print', context),
      ),
      body: Center(
        child: Container(
                          ...
                          (device) => ListTile(
                            ...
                            trailing: OutlinedButton(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                    getTranslated('print_invoice', context)!,
                  ...
                  child: Padding(
                    ...
                    child: OutlinedButton(
                      ...
                      child: Padding(
                        ...
                        child: Text(getTranslated('print_invoice', context)!,
                            textAlign: TextAlign.center),
                      ),
                    ),
                  ),
