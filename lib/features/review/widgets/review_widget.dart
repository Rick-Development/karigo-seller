...
class ReviewWidget extends StatelessWidget {
  ...
  const ReviewWidget(
      {Key? key, required this.reviewModel, this.isDetails = false, this.index})
      : super(key: key);
                    ...
                    child: Container(
                      ...
                      child: ClipRRect(
                          ...
                          child: CustomImageWidget(
                            image:
                                '${Provider.of<SplashController>(context, listen: false).baseUrls!.productThumbnailUrl}/${reviewModel!.product!.thumbnail}',
                          )),
                    ),
                  ),
                            ...
                            child: SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  String imageUrl =
                                      '${Provider.of<SplashController>(context, listen: false).baseUrls!.reviewImageUrl}/review/${reviewModel!.attachment![index]}';
                                  return InkWell(
                                    onTap: () => showDialog(
                                      context: context,
                                      builder: (ctx) =>
