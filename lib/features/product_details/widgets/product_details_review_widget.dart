...
import 'package:karingo_seller/features/review/domain/models/product_review_model.dart';
...
import 'package:karingo_seller/common/basewidgets/see_more_button_widget.dart';
import 'package:karingo_seller/features/product/widgets/product_review_item_widget.dart';
...
class _ProductReviewWidgetState extends State<ProductReviewWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      child: Consumer<ProductReviewController>(builder: (context, review, _) {
        double fiveStar = 0.0,
            fourStar = 0.0,
            threeStar = 0.0,
            twoStar = 0.0,
                    ...
                    child: Column(
                      ...
                      children: [
                        Column(
                          children: [
                            Align(
                                alignment: Provider.of<LocalizationController>(
                                            context,
                                            listen: false)
                                        .isLtr
