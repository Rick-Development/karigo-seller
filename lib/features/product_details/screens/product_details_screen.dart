...
import 'package:karingo_seller/features/product_details/widgets/product_details_review_widget.dart';
import 'package:karingo_seller/features/product_details/widgets/product_details_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: RefreshIndicator(
          ...
          child:
              Consumer<AuthController>(builder: (authContext, authProvider, _) {
