...
class SelectCategoryWidget extends StatefulWidget {
  ...
  const SelectCategoryWidget({Key? key, required this.product})
      : super(key: key);
              ...
              child: DropdownButton<int>(
                ...
                items: resProvider.categoryIds.map((int? value) {
                  return DropdownMenuItem<int>(
                    ...
                    child: Text(value != 0
                        ? resProvider
                            .categoryList![
                                (resProvider.categoryIds.indexOf(value) - 1)]
                            .name!
                ...
                onChanged: (int? value) {
                  ...
                  resProvider.getSubCategoryList(
                      context,
                      value != 0 ? resProvider.categorySelectedIndex : 0,
                      true,
                      widget.product);
                },
                isExpanded: true,
              ...
              children: [
                Flexible(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(getTranslated('sub_category', context)!,
                          style: robotoRegular.copyWith(
                              color: ColorResources.titleColor(context),
                              fontSize: Dimensions.fontSizeDefault)),
                      const SizedBox(
                      ...
                      Container(
                        ...
                        child: DropdownButton<int>(
                          ...
                          onChanged: (int? value) {
                            ...
                            resProvider.getSubSubCategoryList(
                                value != 0
                                    ? resProvider.subCategorySelectedIndex
                                    : 0,
                                true);
                          },
                          isExpanded: true,
                ...
                Flexible(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(getTranslated('sub_sub_category', context)!,
                          style: robotoRegular.copyWith(
                              color: ColorResources.titleColor(context),
                              fontSize: Dimensions.fontSizeDefault)),
                      const SizedBox(height: Dimensions.paddingSizeSmall),
                      Container(
                        ...
                        child: DropdownButton<int>(
                          ...
                          items:
                              resProvider.subSubCategoryIds.map((int? value) {
                            return DropdownMenuItem<int>(
                              value:
                                  resProvider.subSubCategoryIds.indexOf(value),
                              child: Text(value != 0
                                  ? resProvider
                                      .subSubCategoryList![(resProvider
                                              .subSubCategoryIds
                                              .indexOf(value) -
                                          1)]
                                      .name!
