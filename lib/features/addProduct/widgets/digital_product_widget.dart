...
class DigitalProductWidget extends StatefulWidget {
  ...
  const DigitalProductWidget({Key? key, this.resProvider, this.product})
      : super(key: key);
...
class _DigitalProductWidgetState extends State<DigitalProductWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Container(
            ...
            child: DropdownButton<String>(
              value: widget.resProvider!.productTypeIndex == 0
                  ? 'physical'
                  : 'digital',
              ...
              onChanged: (value) {
                widget.resProvider!
                    .setProductTypeIndex(value == 'physical' ? 0 : 1, true);
              },
              isExpanded: true,
      ...
      SizedBox(
          height: widget.resProvider!.productTypeIndex == 1
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: DropdownButton<String>(
                        value: widget.resProvider!.digitalProductTypeIndex == 0
                            ? 'ready_after_sell'
                            : 'ready_product',
                        items: <String>['ready_after_sell', 'ready_product']
                            .map((String value) {
                          return DropdownMenuItem<String>(
                              value: value,
                              child: Text(getTranslated(value, context)!));
                        ...
                        onChanged: (value) {
                          widget.resProvider!.setDigitalProductTypeIndex(
                              value == 'ready_after_sell' ? 0 : 1, true);
                        },
                        isExpanded: true,
                        underline: const SizedBox(),
                      ),
      ...
      SizedBox(
          height: widget.resProvider!.productTypeIndex == 1
              ...
              : 0),
      widget.resProvider!.productTypeIndex == 1 &&
              widget.resProvider!.digitalProductTypeIndex == 1
          ? Padding(
              padding: const EdgeInsets.fromLTRB(
                  Dimensions.paddingSizeDefault,
                  Dimensions.paddingSizeDefault,
