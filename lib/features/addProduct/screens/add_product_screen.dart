...
import 'package:karingo_seller/features/addProduct/screens/add_product_next_screen.dart';
import 'package:karingo_seller/features/addProduct/widgets/digital_product_widget.dart';
import 'package:karingo_seller/features/addProduct/widgets/select_category_widget.dart';
import 'package:karingo_seller/features/addProduct/widgets/title_and_description_widget.dart';
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                      height: Provider.of<SplashController>(
                                                      context,
                                                      listen: false)
                                                  .configModel!
                                                  .brandSetting ==
                                          ...
                                          if (haveBlankTitle) {
                                            ...
                                            showCustomSnackBarWidget(
                                                ...
                                                context);
                                                  ...
                                                  resProvider.digitalProductTypeIndex ==
                                                      1 &&
                                                  resProvider.selectedFileForImport ==
                                                      null) &&
                                              widget.product == null) {
                                            showCustomSnackBarWidget(
                                                getTranslated(
                                                    'please_choose_digital_product',
                                                    context),
                                                context);
                                          } else if (resProvider.categoryIndex ==
                                              0) {
                                            showCustomSnackBarWidget(
                                                getTranslated(
                                                    'select_a_category',
                                            ...
                                            showCustomSnackBarWidget(
                                                getTranslated(
                                                    'select_a_unit', context),
                                                context);
                                          } else if (resProvider.productCode.text ==
                                                  '' ||
                                              resProvider
                                            ...
                                            if (resProvider.productTypeIndex ==
                                                ...
                                                resProvider
                                                    ...
                                                    null) {
                                              resProvider.uploadDigitalProduct(
                                                ...
                                                MaterialPageRoute(
                                                    builder: (_) => AddProductNextScreen(
                                                        categoryId: resProvider
                                                            ...
                                                            .toString(),
                                                        subCategoryId:
                                                            resProvider.subCategoryIndex != 0
                                                        ...
                                                        subSubCategoryId:
                                                            resProvider.subSubCategoryIndex != 0
                                                                ? resProvider
                                                                    .subSubCategoryList![resProvider.subSubCategoryIndex! - 1]
                                                                    .id
                                                                    .toString()
                                                                : "-1",
