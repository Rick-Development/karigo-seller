...
class AddProductSeoScreenState extends State<AddProductSeoScreen> {
  ...
  void initState() {
    ...
    if (_update) {
      ...
      Provider.of<AddProductController>(context, listen: false)
          .productReturnImage = _product!.images;
    } else {
      _product = Product();
                      ...
                      child: (resProvider.attributeList != null &&
                          ...
                          ? Column(
                              ...
                              children: [
                                ...
                                TextFieldTags(
                                  textfieldTagsController: _controller,
                                  initialTags: (_update && tagList.isNotEmpty)
                                      ? tagList
                                      : const [],
                                ...
                                CustomTextFieldWidget(
                                  ...
                                  hintText:
                                      getTranslated('meta_title', context),
                                ),
                                const SizedBox(
                                    height: Dimensions.paddingSizeSmall),
                                Text(
                                    getTranslated('meta_description', context)!,
                                    style: robotoRegular.copyWith(
                                        fontSize: Dimensions.fontSizeDefault)),
                                const SizedBox(
                                ...
                                CustomTextFieldWidget(
                                  ...
                                  hintText: getTranslated(
                                      'meta_description_hint', context),
                                ),
                                const SizedBox(
                                    height: Dimensions.paddingSizeDefault),
                                Text(
                                    getTranslated(
                                        'youtube_video_link', context)!,
                                    style: robotoRegular.copyWith(
                                        fontSize: Dimensions.fontSizeDefault)),
                                const SizedBox(
                                    height: Dimensions.paddingSizeExtraSmall),
                                CustomTextFieldWidget(
                                  ...
                                  hintText:
                                      'https://www.youtube.com/embed/HHE7',
                                ),
                                const SizedBox(
                                    height: Dimensions.paddingSizeSmall),
                                        ...
                                        child: resProvider.pickedMeta != null
                                            ...
                                            : widget.product != null
                                                ? FadeInImage.assetNetwork(
                                                    ...
                                                    image:
                                                        '${Provider.of<SplashController>(context).configModel!.baseUrls!.productImageUrl}/meta/${_product!.metaImage ?? ''}',
                                                    height: 120,
                                                    width: 150,
                                                    fit: BoxFit.cover,
                                            ...
                                            : widget.product != null
                                                ? FadeInImage.assetNetwork(
                                                    placeholder:
                                                        Images.placeholderImage,
                                                    image:
                                                        '${Provider.of<SplashController>(context).configModel!.baseUrls!.productThumbnailUrl}/${_product!.thumbnail ?? ''}',
                                                    height: 120,
                                                    width: 150,
                                                    fit: BoxFit.cover,
                                                    imageErrorBuilder: (c, o,
                                ...
                                if (resProvider.attributeList![0].active &&
                                    resProvider
                                        .attributeList![0].variants.isNotEmpty)
                                  GridView.builder(
                                      gridDelegate:
                                                          ...
                                                          DottedBorder(
                                                              ...
                                                              child: ClipRRect(
                                                                  ...
                                                                  child: (_update)
                                                                      ? CustomImageWidget(
                                                                          image:
                                                                              "${Provider.of<SplashController>(context, listen: false).configModel?.baseUrls?.productImageUrl}/${resProvider.withColor[index].imageString}",
                                                                ...
                                                                child: ClipRRect(
                                                                    borderRadius: const BorderRadius
                                                                        ...
                                                                        Radius.circular(Dimensions
                                                                            .paddingSizeSmall)),
                                                                    child: Image.file(
                                                                        File(resProvider.withColor[index].image!.path),
                                                                        width: MediaQuery.of(context).size.width / 2.3,
                                                                        height: MediaQuery.of(context).size.width / 2.3,
                                                                        fit: BoxFit.cover)))),
                                                        Positioned(
                                                  ...
                                                  child: Container(
                                                      ...
                                                      child: ClipRRect(
                                                          ...
                                                          child: CustomImageWidget(
                                                              image:
                                                                  "${Provider.of<SplashController>(context, listen: false).configModel?.baseUrls?.productImageUrl}/${resProvider.imagesWithoutColor[index]}",
                                                              width:
                                ...
                                GridView.builder(
                                    ...
                                    physics:
                                        const NeverScrollableScrollPhysics(),
                                    itemCount:
                                        resProvider.withoutColor.length + 1,
                                    itemBuilder: (BuildContext context, index) {
                                      return index ==
                                              resProvider.withoutColor.length
                                          ? GestureDetector(
                                              onTap: () =>
                                                  resProvider.pickImage(false,
                                                      false, false, null),
                                              child: Stack(
                                                children: [
                                                  DottedBorder(
                          ...
                          ? CustomButtonWidget(
                              ...
                              onTap: () {
                                ...
                                for (TextEditingController textEditingController
                                  ...
                                  titleList
                                      .add(textEditingController.text.trim());
                                }
                                for (var description
                                    in resProvider.descriptionControllerList) {
                                ...
                                if (!_update &&
                                  ...
                                  showCustomSnackBarWidget(
                                      getTranslated(
                                          'upload_thumbnail_image', context),
                                      context);
                                } else if (!_update &&
                                  ...
                                  _product!.shippingCost = PriceConverter
                                      .systemCurrencyToDefaultCurrency(
                                          double.parse(widget.shippingCost!),
                                          context);
                                  ...
                                  _product!.minimumOrderQty =
                                      int.parse(widget.minimumOrderQuantity!);
                                  _product!.metaTitle = seoTitle;
                                  _product!.metaDescription = seoDescription;
                                  _product!.discountType =
                                      resProvider.discountType;
                                  _product!.digitalProductType =
                                      resProvider.digitalProductTypeIndex == 0
                                          ? 'ready_after_sell'
                                          : 'ready_product';
                                  ...
                                  _product!.categoryIds!
                                      .add(CategoryIds(id: widget.categoryId));

                                  if (resProvider.subCategoryIndex != 0) {
                                    _product!.categoryIds!.add(
                                        CategoryIds(id: widget.subCategoryId));
                                  }
                                  ...
                                  if (_update) {
                                    ...
                                    for (int i = 0;
                                        ...
                                        i++) {
                                      if (resProvider.withColor[i].image !=
                                          null) {
                                        withc++;
                                      }
                                    }
                                    ...
                                    for (int i = 0;
                                        i < resProvider.withoutColor.length;
                                        i++) {
                                      if (resProvider.withoutColor[i].image !=
                                          null) {
                                        withOurC++;
                                      }
                                    }
                                    ...
                                    if (resProvider.withoutColor.isNotEmpty) {
                                      for (int i = 0;
                                          ...
                                          i++) {
                                        resProvider.addProductImage(context,
                                            resProvider.withoutColor[i], route);
                                      }
                                    }
                                  }
                                }
