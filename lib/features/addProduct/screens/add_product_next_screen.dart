...
import 'package:karingo_seller/common/basewidgets/attribute_view_widget.dart';
...
import 'package:karingo_seller/features/addProduct/domain/models/attribute_model.dart';
import 'package:karingo_seller/features/product/domain/models/product_model.dart';
import 'package:karingo_seller/features/addProduct/domain/models/variant_type_model.dart';
...
import 'package:karingo_seller/features/addProduct/screens/add_product_seo_screen.dart';
...
class AddProductNextScreenState extends State<AddProductNextScreen> {
  ...
  void initState() {
    ...
    _load();
    if (_update) {
      _unitPriceController.text = PriceConverter.convertPriceWithoutSymbol(
          context, _product!.unitPrice);
      _taxController.text = _product!.tax.toString();
      Provider.of<AddProductController>(context, listen: false)
          .setCurrentStock(_product!.currentStock.toString());
      ...
      _minimumOrderQuantityController.text =
          _product!.minimumOrderQty.toString();
      Provider.of<AddProductController>(context, listen: false)
                  ...
                  for (int index = 0;
                    ...
                    Future.delayed(Duration.zero, () async {
                      resProvider.addVariant(
                          ...
                          false);
                      resProvider
                          .addColorCode(widget.product!.colors![index].code);
                    });
                  }
                }
              }
                          ...
                          ? Column(
                              ...
                              children: [
                                        ...
                                        children: [
                                          ...
                                          resProvider.attributeList![0].active
                                              ? Consumer<SplashController>(
                                                  builder: (ctx, colorProvider,
                                                      child) {
                                                  if (colorProvider.colorList !=
                                                      null) {
                                                    for (int index = 0;
                                                        index <
                                                            colorProvider
                                                              ...
                                                              child: Row(
                                                                  children: [
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () {
                                                                        resProvider.removeVariant(
                                                                            context,
                                                                            0,
                                                                            index,
                                                                            widget.product);
                                                                        resProvider
                                                                            .removeColorCode(index);
                                                                      },
                                                                      child: Icon(
                                                                          Icons
                                                                              .close,
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                        getTranslated('product_price_and_stock',
                                            context)!,
                                        style: robotoBold.copyWith(
                                            color:
                                                ColorResources.getHeadTextColor(
                                                    context),
                                            fontSize:
                                ...
                                Row(children: [
                                  Expanded(
                                      child: Column(
                                          ...
                                          children: [
                                        Text(
                                          getTranslated('tax_model', context)!,
                                          style: robotoRegular.copyWith(
                                              fontSize:
                                        ...
                                        Container(
                                          ...
                                          child: DropdownButton<String>(
                                            value: resProvider.taxTypeIndex == 0
                                                ? 'include'
                                                : 'exclude',
                                            items: <String>[
                                              'include',
                                                ...
                                                Expanded(
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        getTranslated(
                                                            'shipping_cost_multiply_by_item',
                                                            context)!,
                                                        style: robotoRegular.copyWith(
                                                            fontSize: Dimensions
                                                                .fontSizeSmall,
                        ...
                        Expanded(child: Consumer<AddProductController>(
                          ...
                          return CustomButtonWidget(
                            ...
                            onTap: () {
                              ...
                              String currentStock = resProvider
                              ...
                              for (VariantTypeModel variantType
                                  in resProvider.variantTypeList) {
                              ...
                              if (unitPrice.isEmpty) {
                                ...
                                showCustomSnackBarWidget(
                                    getTranslated(
                                        'enter_total_quantity', context),
                                    context);
                              } else if (orderQuantity.isEmpty) {
                                showCustomSnackBarWidget(
                                    getTranslated(
                                        'enter_minimum_order_quantity',
                                        context),
                                    context);
                                ...
                                showCustomSnackBarWidget(
                                    getTranslated(
                                        'enter_price_for_every_variant',
                                        context),
                                    context);
                              } else if (blankVariantQuantity) {
                                showCustomSnackBarWidget(
                                    getTranslated(
                                        'enter_quantity_for_every_variant',
                                        context),
                                    context);
                              } else {
                                Navigator.push(
