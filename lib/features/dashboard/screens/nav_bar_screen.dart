...
import 'package:karingo_seller/features/dashboard/widgets/gradient_border_widget.dart';
...
class _NavBarScreenState extends State<NavBarScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer<BottomMenuController>(
      ...
      return Scaffold(
        ...
        floatingActionButton: UnicornOutlineButtonWidget(
            strokeWidth: 0,
            radius: 50,
          ...
          child: Row(
            ...
            children: [
              customBottomItem(
                ...
                name: getTranslated('pos', context)!,
                selectIndex: 0,
              ),
              customBottomItem(
                  ...
                  icon: menuController.currentTab == 1
                      ? Images.order
                      : Images.order,
                  name: getTranslated('my_order', context)!,
                  selectIndex: 1),
              ...
              customBottomItem(
                ...
                icon: menuController.currentTab == 2
                    ? Images.productIcon
                    : Images.productIcon,
                name: getTranslated('products', context)!,
                selectIndex: 2,
              ),
              customBottomItem(
                tap: () {
        ...
        children: [
          SizedBox(
            ...
            child: Image.asset(
              icon,
              fit: BoxFit.contain,
              color: Provider.of<BottomMenuController>(context, listen: false)
                          .currentTab ==
                      selectIndex
